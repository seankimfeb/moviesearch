...
public class MovieApiClient {
    ...
    public static String searchMovieByTitle(String title,String key){
        try {
         ...
         String requestUrl = "http://www.omdbapi.com/?s=TITLE&apikey=APIKEY".replaceAll("TITLE", title).replaceAll("APIKEY", key);
         return sendGetRequest(requestUrl);
    }
    /** 
    private final RestTemplate restTemplate;
      private final String omdb_getMovies = "http://www.omdbapi.com/?s=TITLE&apikey=APIKEY";
      private 
       public MovieResponseDto requestMovie(String title,String key) {
        ...
        String requestURL = omdb_getMovies.replaceAll("TITLE", title).replaceAll("APIKEY", key);
        //create http entity
        //final HttpEntity<String> entity = new HttpEntity<>(headers);

        return restTemplate.exchange(omdb_getMovies, HttpMethod.GET, entity, MovieResponseDto.class, keyword).getBody();
    }
    **/
